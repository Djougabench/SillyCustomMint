...
import tokensOG from "../../tokensOG.json";
import { MerkleTree } from "merkletreejs";
import keccak256 from "keccak256";

const OGWhitelistSale = (props) => {
  ...
  const mint = async (quantity) => {
    ...
    let overrides = {
      value: props.BNOGWlSalePrice.mul(quantity),
    };
    ...
    try {
      let transaction = await contract.OGWhitelistMint(
        account,
        quantity,
        proof,
        overrides
...
export default OGWhitelistSale;
